...
/// 질의
/// </summary>
public class DOCUMENT_QUESTION : DOCUMENT_ENTITY_BASE
{
    /// <summary>
    /// 문서 CHAT 마스터 ID
    /// </summary>
    ...
    /// 문서 CHAT 마스터
    /// </summary>
    public virtual DOCUMENT_THREAD Thread { get; set; }
    ...
    /// 응답에 사용된 데이터셋
    /// </summary>
    public virtual ICollection<DOCUMENT_QUESTION_RESEARCH> QuestionSearches { get; set; }
    /// <summary>
    /// 응답
    /// </summary>
    public virtual ICollection<DOCUMENT_ANSWER> Answers { get; set; }
}

public class DocumentQuestionEntityConfiguration: IEntityTypeConfiguration<DOCUMENT_QUESTION>
{
    public void Configure(EntityTypeBuilder<DOCUMENT_QUESTION> builder)
    {
        builder.ToTable($"{nameof(DOCUMENT_QUESTION)}", "dbo");
