...
/// <param name="ItemId"></param>
/// <param name="IsFolder">false:파일, true:폴더</param>
public sealed record TopicMetadataProcessItem(Guid TopicId, string TopicName, Guid JobId, Guid MedataId, string Path, string DriveId, string ItemId, bool IsFolder, bool IsDelete, Guid UserId);