...
public interface IGetDocumentService : IDiaExecuteServiceBase<string, Results<string>>;

/// <summary>
/// 문서 조회 및 blob 링크 제공
/// </summary>
public class GetDocumentService : DiaExecuteServiceBase<GetDocumentService, DiaDbContext, string, Results<string>>, IGetDocumentService
{
